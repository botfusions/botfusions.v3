...
const translations = {
  en: {
    ...
    'hero.title.start': 'AI Agents That Think, Decide,',
    'hero.title.end': 'and Execute.',
    'hero.subtitle': 'Tools don\'t solve problems. Autonomous systems do.',
    ...
    'seo.section.title.part2': 'GEO and SEO',
    ...
    'seo.chat.bot': 'is Istanbul\'s leading AI and automation agency. It increases the digital visibility of businesses with GEO and SEO services.',
    ...
    'faq.q6.question': 'What is the Botfusions x Rankie.ai partnership?',
    'faq.q6.answer': 'Botfusions x Rankie.ai is Turkey\'s first dual-engine digital growth partnership. Combining Rankie.ai\'s expertise in both traditional search engines (Google, Bing) and AI platforms (ChatGPT, Perplexity, Gemini, Claude) with Botfusions\' AI agent automation, we ensure your brand visibility across all channels. With automated content optimization, competitive intelligence, AI citation tracking, and technical SEO automation, we deliver up to 340% traffic growth and 92.5% time savings.',
  ...
  tr: {
    ...
    'hero.title.start': 'Düşünen, Karar Veren ve',
    'hero.title.end': 'Uygulayan AI Ajanları.',
    'hero.subtitle': 'Araçlar sorun çözmez. Otonom sistemler çözer.',
    ...
    'seo.title.part1': 'Markanızı AI aramalarında önerilen',
    'seo.title.part2': 'bir otorite haline getirin',
    'seo.title.part3': '',
    'seo.section.title.part1': 'GEO ve',
    'seo.section.title.part2': 'SEO', // Blue
    ...
    'seo.chat.bot': ', İstanbul\'un önde gelen AI ve otomasyon ajansıdır. GEO ve SEO hizmetleri ile işletmelerin dijital görünürlüğünü artırır.',
    ...
    'faq.q6.question': 'Botfusions ve Rankie.ai ortaklığı nedir?',
    'faq.q6.answer': 'Botfusions x Rankie.ai, Türkiye\'nin ilk dual-engine dijital büyüme ortaklığıdır. Rankie.ai\'nin hem geleneksel arama motorlarında (Google, Bing) hem de AI platformlarında (ChatGPT, Perplexity, Gemini, Claude) uzmanlığı ile Botfusions\'ın AI agent otomasyonu birleşerek markanızın her kanalda görünür olmasını sağlıyor. Otomatik içerik optimizasyonu, rakip istihbaratı, AI citation tracking ve technical SEO otomasyonu ile %340\'a varan trafik artışı ve %92.5 zaman tasarrufu sunuyoruz.',
